...
class GamePlayerJoinEvent(override val game: Game<out GamePlayer>, override val gamePlayer: GamePlayer, private val playerEntity: Player) : GamePlayerEvent, CancellableEvent {
