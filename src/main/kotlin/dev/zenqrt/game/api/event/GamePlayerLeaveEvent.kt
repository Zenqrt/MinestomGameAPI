...
class GamePlayerLeaveEvent(override val game: Game, override val gamePlayer: GamePlayer, private val playerEntity: Player) : GameEvent, GamePlayerEvent, CancellableEvent {
