...
open class GameOnlyPredicate<T : Event>(private val game: Game<out GamePlayer>, private val player: (T) -> Player) : (T) -> Boolean {
    override fun invoke(t: T): Boolean = game.gamePlayers.any { it.key == player }
}
