...
class CountdownPhase(private val game: ChristmasGame, private val gameOptions: GameOptions, private val messageFormatter: ChristmasTextFormatter) : GamePhase("countdown") {
    ...
    override fun start() {
        ...
        addTrait(MaxPlayerLimitCancelEventTrait(
            eventNode,
            EventListener.builder(GamePlayerJoinEvent::class.java)
