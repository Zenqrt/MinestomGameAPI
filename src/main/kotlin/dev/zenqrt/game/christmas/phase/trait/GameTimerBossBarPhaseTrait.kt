...
class GameTimerBossBarPhaseTrait(private val phase: GamePhase, private val time: Int) : PhaseTrait {
    ...
    private fun getGameTimerText(time: Int): Component = miniMessage.parse("<blue>Game Time: <aqua>${time}s")
