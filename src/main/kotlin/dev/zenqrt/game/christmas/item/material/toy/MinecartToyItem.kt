...
import dev.zenqrt.game.christmas.item.material.toy.MinecartBody.DISPLAY_NAME
...
class MinecartToyItem : WrappableItem() {
    override val id = "toy_minecart"
    override val model = ItemStack.builder(Material.MINECART)
        .displayName(Component.text("Toy Minecart", NamedTextColor.AQUA).noItalic())
        .build()
}
